...
{
    static string _path = @"C:\Users\dakuz\RiderProjects\Weather\Weather\City.txt";
    ...
    public class City
    {
        ...
        public Temper Temperature { get; set; }    
    }
    ...
    static void Main()
    {
        ...
        try
        { 
            responseBody = GetJsonStringFromUrl("http://openweathermap.org/data/2.5/find?q=" + city + "&appid=439d4b804bc8187953eb36d2a8c26a02&units=metric");
        }
        catch
        {
        ...
        if (city != "")
        {
            ...
            {
                Console.WriteLine("{0} - {1} C", c.Name, Math.Round(c.Temperature.Value-273.15, 2, MidpointRounding.ToEven));
            }
        }
        ...
        while(flag)
        {
            Console.WriteLine("Выберите команду (города вводить на англиском языке с малненькой буквы): \n 1 - сохранить/изменить город по умолчанию \n 2 - узнать погоду по городу с клавиатуры \n 3 - завершить работу программы");
